...
public class CrearBDxml {
    ...
    private String extensionFiltro = "xml,xhtml";

    public CrearBDxml() throws QizxException, IOException {
        //variables locales
        String nombre;
        //filtro de ficheros
     ...
     */
    private LibraryManager obtenerBDManager(File directorioGrupo)
    ...
    private Library obtenerBD(LibraryManager bdManager, String bdNombre) throws QizxException {
     ...
     * @throws SAXException
     */
    private void llenar(Library bd, File fichero, FileFilter filtro,
            String ruta)
